    ...
    <div class="row">
        <div class="col-lg-12">
            @if (Auth::user()->role == "ukm")
                <button class="btn btn-primary" id="btnTambah">+ Tambah Agenda </button>
            @endif
            <div class="card mt-4">
    ...
    <div class="modal fade modalForm" tabindex="-1" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <form action="{{ route('agenda-simpan') }}" method="POST" id="formData">
                    @csrf
                ...
                <div class="modal-body text-center p-5">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="hstack gap-2 justify-content-center">
                            <form action="{{ route('agenda-hapus') }}" method="POST">
                                @csrf
            ...
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="hstack gap-2 justify-content-center">
                            <form action="{{ route('agenda-tolak') }}" method="POST">
                                @csrf
            ...
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="hstack gap-2 justify-content-center">
                            <form action="{{ route('agenda-terima') }}" method="POST">
                                @csrf
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.alert == '1') {
                        ...
                        $('#formData')[0].reset();
                        $('#formData').attr("action", "{{ route('agenda-simpan') }}" + "/" + data.id);
