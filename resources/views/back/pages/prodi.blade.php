...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <button class="btn btn-primary" id="btnTambah">+ Tambah Data Prodi </button>
            <div class="card mt-4">
                                ...
                                @foreach ($data as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('jurusan', [$item->id]) }}" class="btn btn-sm btn-warning">Jurusan</a>
    ...
    <div class="modal fade modalForm" tabindex="-1" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <form action="{{ route('prodi-simpan') }}" method="POST" id="formData" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="modal-body text-center p-5">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="hstack gap-2 justify-content-center">
                            <form action="{{ route('prodi-hapus') }}" method="POST">
                                @csrf
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.alert == '1') {
                        ...
                        $('#formData')[0].reset();
                        $('#formData').attr("action", "{{ route('prodi-simpan') }}" + "/" + data.id);
