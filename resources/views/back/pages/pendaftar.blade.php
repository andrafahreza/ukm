                            ...
                            <tbody>
                                @foreach ($data as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if (Auth::user()->role == "ukm" && $item->status == "menunggu")
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    <i class="bi bi-exclamation-triangle text-warning display-5"></i>
                    <div class="mt-4">
                        <form action="{{ route('tolak-pendaftaran') }}" method="POST">
                            <h4 class="mb-3">Tolak Pendaftaran</h4>
                            <p class="text-muted mb-4"> Yakin ingin menolak mahasiswa ini untuk masuk ke dalam UKM? </p>
