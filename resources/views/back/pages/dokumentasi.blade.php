...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <button class="btn btn-primary" id="btnTambah">+ Tambah Dokumentasi </button>
            <div class="card mt-4">
    ...
    <div class="modal fade modalForm" tabindex="-1" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <form action="{{ route('dokumentasi-simpan') }}" method="POST" id="formData" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="modal-body text-center p-5">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="hstack gap-2 justify-content-center">
                            <form action="{{ route('dokumentasi-hapus') }}" method="POST">
                                @csrf
...
@push('scripts')
    ...
    <script>
        ...
        function detail(id) {
            $('#formData')[0].reset();
            var url = "{{ route('dokumentasi-show') }}" + "/" + id;
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.alert == '1') {
                        ...
                        $('#formData')[0].reset();
                        $('#formData').attr("action", "{{ route('dokumentasi-simpan') }}" + "/" + data.id);
                    } else {
